...
export default function MultiModalChatPage() {
  ...
  return (
    <div className='min-h-screen flex flex-col w-full max-w-md pt-12  pb-64 mx-auto stretch mt-4  '>
      ...
      <form
        ...
        className='fixed bottom-24 w-full max-w-xl mx-auto left-0 right-0 p-4 bg-zinc-50 dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 shadow-lg'
      >
          ...
          <div className='flex items-center gap-2'>
            ...
            >
              ...
              {files?.length
                ...
                : "Dołącz fakturę PDF lub zdjęcie faktury"}
            </label>
            <input
              id='file-upload'
              type='file'
